...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2021 a las 21:22:01
...
--
-- Base de datos: `listascompras`
--
CREATE DATABASE IF NOT EXISTS `listascompras` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `listascompras`;
...
--
-- Estructura de tabla para la tabla `listaencabezado`
--

CREATE TABLE `listaencabezado` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `listaitems` (
  ...
  `listaencabezado_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indices de la tabla `listaencabezado`
--
ALTER TABLE `listaencabezado`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `listaitems`
  ADD PRIMARY KEY (`id`),
  ADD KEY `listaencabezado_id` (`listaencabezado_id`),
  ADD KEY `listaitems_ibfk_1` (`producto_id`);
...
--
-- AUTO_INCREMENT de la tabla `listaencabezado`
--
ALTER TABLE `listaencabezado`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `listaitems`
--
ALTER TABLE `listaitems`
  ADD CONSTRAINT `listaitems_ibfk_1` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`),
  ADD CONSTRAINT `listaitems_ibfk_2` FOREIGN KEY (`listaencabezado_id`) REFERENCES `listaencabezado` (`id`);
...
('root', '[{\"db\":\"prestamolibros\",\"table\":\"libro\"},{\"db\":\"prestamolibros\",\"table\":\"categoria\"},{\"db\":\"prestamolibros\",\"table\":\"persona\"},{\"db\":\"listascompras\",\"table\":\"listaitems\"},{\"db\":\"prestamolibros\",\"table\":\"autor\"},{\"db\":\"prestamolibros\",\"table\":\"genero\"},{\"db\":\"listascompras\",\"table\":\"producto\"},{\"db\":\"listascompras\",\"table\":\"categorias\"},{\"db\":\"listascompras\",\"table\":\"listaencabezado\"}]');
...
('listascompras', 'producto', 'nombre'),
('prestamolibros', 'libro', 'nombre');
...
('root', '2021-06-09 19:21:19', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
...
--
CREATE DATABASE IF NOT EXISTS `prestamolibros` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `prestamolibros`;
